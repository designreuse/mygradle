...
<div id="dcMain">
    ...
    <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="user_showadd" class="actionBtn add">添加用户</a>用户列表</h3>
        <div class="filter">
            ...
            <form name="action" method="post" action="product.php?rec=action">
                <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                    <tr>
                        ...
                        <th align="left">姓</th>
                        <th width="150" align="center">名</th>
                    ...
                    <tr>
                        ...
                        <td><a href="product.php?rec=edit&id=15">${user.firstname}</a></td>
                        <td align="center"><a href="product.php?cat_id=3">${user.lastname}</a></td>
                        <td align="center">${user.age}</td>
                        <td align="center">
                            <a href="user_detail?user.id=${user.id}">编辑</a> | <a href="product.php?rec=del&id=15">删除</a>
                        </td>
                    </tr>
                    </c:forEach>
